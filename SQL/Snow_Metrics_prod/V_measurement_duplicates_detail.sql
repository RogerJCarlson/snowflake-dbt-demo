...
CREATE OR REPLACE VIEW OMOP_QA.V_MEASUREMENT_DUPLICATES_DETAIL AS (
---------------------------------------------------------------------
--MEASUREMENT_DUPLICATES_DETAIL
---------------------------------------------------------------------
WITH TMP_DUPES AS (
SELECT PERSON_ID
...
FROM TMP_DUPES AS D
INNER JOIN CDM.MEASUREMENT AS ME ON D.PERSON_ID = ME.PERSON_ID
