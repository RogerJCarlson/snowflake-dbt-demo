...
--DROP VIEW CDM.V_VISIT_OCCURRENCE_DUPLICATES_DETAIL;
CREATE OR REPLACE VIEW OMOP_QA.V_VISIT_OCCURRENCE_DUPLICATES_DETAIL AS (
---------------------------------------------------------------------
--VISIT_OCCURRENCE_DUPLICATES_DETAIL
---------------------------------------------------------------------
...
INNER JOIN CDM.VISIT_OCCURRENCE AS VI ON D.PERSON_ID = VI.PERSON_ID
