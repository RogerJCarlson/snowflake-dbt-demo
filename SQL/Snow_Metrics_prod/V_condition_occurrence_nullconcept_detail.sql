...
--DROP VIEW CDM.V_CONDITION_OCCURRENCE_NULLCONCEPT_DETAIL;
CREATE OR REPLACE VIEW OMOP_QA.V_CONDITION_OCCURRENCE_NULLCONCEPT_DETAIL AS (
---------------------------------------------------------------------
------CONDITION_OCCURRENCE_NULLCONCEPT_DETAIL
---------------------------------------------------------------------
