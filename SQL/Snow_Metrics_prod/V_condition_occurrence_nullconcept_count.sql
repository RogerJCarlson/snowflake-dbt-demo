...
--DROP VIEW CDM.V_CONDITION_OCCURRENCE_NULLCONCEPT_COUNT;
CREATE OR REPLACE VIEW OMOP_QA.V_CONDITION_OCCURRENCE_NULLCONCEPT_COUNT AS (
---------------------------------------------------------------------
------CONDITION_OCCURRENCE_NULLCONCEPT_COUNT
---------------------------------------------------------------------
