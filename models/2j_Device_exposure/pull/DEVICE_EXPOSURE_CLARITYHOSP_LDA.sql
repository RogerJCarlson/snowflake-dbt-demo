--DEVICE_EXPOSURE_CLARITYHOSP_LDA
...
SELECT DISTINCT SUBSTRING(AOU_DRIVER.AOU_ID, 2, LEN(AOU_DRIVER.AOU_ID)) AS PERSON_ID
	...
	,'PULL_DEVICE_EXPOSURE--CLARITYHOSP--LDA' AS ETL_MODULE

--INTO SH_OMOP_DB_PROD.OMOP_CLARITY.DEVICE_EXPOSURE_CLARITYHOSP_LDA
...
INNER JOIN {{ source('CLARITY','IP_LDA_NOADDSINGLE')}} AS IP_LDA_NOADDSINGLE  
	ON (PAT_ENC_HSP.PAT_ENC_CSN_ID = IP_LDA_NOADDSINGLE.PAT_ENC_CSN_ID)
