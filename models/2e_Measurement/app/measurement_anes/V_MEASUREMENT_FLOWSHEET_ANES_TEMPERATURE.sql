--V_MEASUREMENT_FLOWSHEET_ANES_TEMPERATURE
...
--    ,VISIT_DETAIL.VISIT_DETAIL_ID AS VISIT_DETAIL_ID
	...
	,'MEASUREMENT--CLARITYANES--FLOWSHEET_TEMP' AS ETL_MODULE
	,VISIT_SOURCE_VALUE

FROM {{ref('T_TEMPERATURE_MERGE_ANES')}} AS T_TEMPERATURE_MERGE
    ...
    INNER JOIN {{ref('VISIT_OCCURRENCE')}} AS VISIT_OCCURRENCE
    	ON T_TEMPERATURE_MERGE.PAT_ENC_CSN_ID = VISIT_OCCURRENCE.VISIT_SOURCE_VALUE --MAP TO HOSPITAL VISIT
