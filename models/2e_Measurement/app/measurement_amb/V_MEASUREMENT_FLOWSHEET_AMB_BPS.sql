--V_MEASUREMENT_FLOWSHEET_AMB_BPS
...
SELECT DISTINCT --CDM.SEQ_MEASUREMENT.NEXTVAL AS MEASUREMENT_ID
	...
	,32817 AS MEASUREMENT_TYPE_CONCEPT_ID --FROM PHYSICAL EXAMINATION
	,CASE 
...
FROM {{ref('MEASUREMENT_CLARITYAMB_FLOWSHEET')}} AS MEASUREMENT_CLARITYAMB_FLOWSHEET
	...
	LEFT JOIN {{ source('CDM','SOURCE_TO_CONCEPT_MAP')}} AS  SOURCE_TO_CONCEPT_MAP_FLOWSHEET_MEAS_UNITS
		ON 	MEASUREMENT_CLARITYAMB_FLOWSHEET.FLO_MEAS_ID  = SOURCE_TO_CONCEPT_MAP_FLOWSHEET_MEAS_UNITS.SOURCE_CODE 
