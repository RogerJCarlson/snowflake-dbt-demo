...
LEFT JOIN {{ source('CDM','SOURCE_TO_CONCEPT_MAP')}} AS  SOURCE_TO_CONCEPT_MAP_UNIT
	ON UPPER(MEASUREMENT_CLARITYHOSP_LOINC.REFERENCE_UNIT) = UPPER(SOURCE_TO_CONCEPT_MAP_UNIT.SOURCE_CODE)
...
LEFT JOIN {{ source('CDM','SOURCE_TO_CONCEPT_MAP')}} AS  SOURCE_TO_CONCEPT_MAP_VALUE
	ON UPPER(MEASUREMENT_CLARITYHOSP_LOINC.ORD_VALUE) = UPPER(SOURCE_TO_CONCEPT_MAP_VALUE.SOURCE_CODE)
