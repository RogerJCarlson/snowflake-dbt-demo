--V_MEASUREMENT_FLOWSHEET_HSP_VITALS
...
--    ,VISIT_DETAIL.VISIT_DETAIL_ID AS VISIT_DETAIL_ID
	...
	,'MEASUREMENT--CLARITYHOSP--FLOWSHEET_VITALS' AS ETL_MODULE
	,VISIT_SOURCE_VALUE
...
LEFT JOIN {{ source('CDM','SOURCE_TO_CONCEPT_MAP')}} AS SOURCE_TO_CONCEPT_MAP_FLOWSHEET_MEAS_UNITS
	ON 		MEASUREMENT_CLARITYHOSP_FLOWSHEET.FLO_MEAS_ID  = SOURCE_TO_CONCEPT_MAP_FLOWSHEET_MEAS_UNITS.SOURCE_CODE 
