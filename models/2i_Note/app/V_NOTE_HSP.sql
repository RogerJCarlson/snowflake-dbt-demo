...
--CDM.SEQ_NOTE.NEXTVAL AS NOTE_ID
	NOTE_CLARITYHOSP_ALL.PERSON_ID AS PERSON_ID
...
--    ,VISIT_DETAIL.VISIT_DETAIL_ID AS VISIT_DETAIL_ID
	...
	,NOTE_CLARITYHOSP_ALL.IP_NOTE_TYPE_C || ':' || NOTE_CLARITYHOSP_ALL.AMB_NOTE_YN || ':' || ZC_NOTE_TYPE_IP_NAME AS NOTE_SOURCE_VALUE
	,'NOTE--CLARITYHOSP--ALL' AS ETL_MODULE
	,VISIT_SOURCE_VALUE

FROM {{ref('NOTE_CLARITYHOSP_ALL')}} AS NOTE_CLARITYHOSP_ALL

INNER JOIN {{ref('T_MAX_NOTE_DATE_HSP')}} AS T_MAX_NOTE_DATE
