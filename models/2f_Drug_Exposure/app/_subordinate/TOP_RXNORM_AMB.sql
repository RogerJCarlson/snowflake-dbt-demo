...
INNER JOIN (
	...
	FROM {{ source('CDM','CONCEPT')}} AS CONCEPT
	...
	ON DRUG_EXPOSURE_CLARITYAMB_RXNORM.RXNORM_CODE = CONCEPT_CODE

WHERE DRUG_EXPOSURE_CLARITYAMB_RXNORM.RXNORM_TERM_TYPE_C <> 2 --2 - PRECISE INGREDIENT
