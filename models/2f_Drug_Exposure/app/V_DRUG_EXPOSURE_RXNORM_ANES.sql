...
LEFT JOIN {{ source('CDM','SOURCE_TO_CONCEPT_MAP')}} AS  SOURCE_TO_CONCEPT_MAP_ROUTE
	ON UPPER(SOURCE_TO_CONCEPT_MAP_ROUTE.SOURCE_VOCABULARY_ID) = 'SH_ROUTE'
		AND SOURCE_TO_CONCEPT_MAP_ROUTE.SOURCE_CODE = DRUG_EXPOSURE_CLARITYANES_RXNORM.ROUTE_C
